...
def splash_page():
    ...
    if name is not None:
        return home_page()
    if ticket is None:
        images = ['img/cannon.jpeg','img/cap.jpeg', 'img/charter.jpeg', 'img/cloister.jpeg', 'img/colo.jpeg', 'img/cottage.png', 'img/ivy.jpeg', 'img/quad.jpeg', 'img/terrace.jpeg', 'img/ti.jpeg', 'img/tower.jpeg']
