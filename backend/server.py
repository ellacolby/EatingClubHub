...
def splash_page():
    ...
    if name is not None:
        return home_page()
    if ticket is None:
        images = ['styles/cannon.jpeg','styles/cap.jpeg', 'styles/charter.jpeg', 'styles/cloister.jpeg', 'styles/colo.jpeg', 'styles/cottage.jpeg', 'styles/ivy.jpeg', 'styles/quad.jpeg', 'styles/terrace.jpeg', 'styles/ti.jpeg', 'styles/tower.jpeg']
